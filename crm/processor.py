...
def crm_generate(model_name, processed_image, crm_steps, crm_cfg, crm_seed):
    print("\n")
    print("=====================================================")
    print("CRM Generation started.")
    print("- - - - - - - - - - - - - - - - - - - - - - - - - - -")
    print("model_name: " + model_name)
    print("crm_steps: " + str(crm_steps))
    print("crm_cfg: " + str(crm_cfg))
    print("crm_seed: " + str(crm_seed))
    print("- - - - - - - - - - - - - - - - - - - - - - - - - - -")
    print("=====================================================")
    print("\n")
...
# def crm_generate(input_image, seed, scale, step):
